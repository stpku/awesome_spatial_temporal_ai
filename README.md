...
- **[AAAI 2026](https://aaai.org/Conferences/AAAI-2026/)** - AAAI Conference on Artificial Intelligence，涵盖人工智能、世界模型、3D生成等。 `Annual` `AI` `Machine Learning`
...
- **[ICCV 2025](https://iccv2025.org/)** - 国际计算机视觉会议，涵盖时空理解、视频超分辨率等研究。 `Annual` `Computer Vision` `Video Processing`
...
- **[RSS 2025](https://roboticsconference.org/)** - Robotics: Science and Systems Conference，涵盖空间智能、机器人学习等。 `Annual` `Robotics` `Spatial Intelligence`

## 开源项目

### 轨迹预测 (Trajectory Prediction)

- **[LibCity](https://github.com/LibCity/Bigscity-LibCity)** (Stars: 3200) - A unified, comprehensive library for reproducing and developing spatial-temporal prediction methods, facilitating research and application in urban computing. `Python` `PyTorch` `TensorFlow`

- **[TorchSpatiotemporal](https://github.com/nnaisense/TorchSpatiotemporal)** (Stars: 1100) - A PyTorch library for spatiotemporal sequence modeling, providing implementations of various spatiotemporal models. `Python` `PyTorch`
